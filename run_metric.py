...
if __name__ == "__main__":
    ...
    # for data_type in ['Basic_Generation']:
    for data_type in ['Basic_Generation', 'Iterative_Refinement', 'Basic_Generation_with_img', 'Basic_Generation_with_code']:
    ...
    # # for data_type in ['Iterative_Refinement', 'Basic_Generation', 'Basic_Generation_with_img', 'Basic_Generation_with_code']:
    # for data_type in ['Basic_Generation_with_code']:
