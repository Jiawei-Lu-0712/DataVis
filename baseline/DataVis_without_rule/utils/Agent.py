...
<example>
<Question>
Can you create a scatter plot showing how each activity's average student age differs from the overall average? Put activity names on the x-axis and the age difference in years on the y-axis. Title it "Difference in Average Age by Activity" and color-code the points using a red-blue scheme where red shows activities with younger-than-average students and blue shows older-than-average students.
</Question>
<Thought>
I need to calculate the average age for each activity and then compare it to the overall average age. I can use the `calculate_average_age` tool to get the average age for each activity and the `calculate_overall_average_age` tool to get the overall average age.
</Thought>
<Action>
{{"tool_name": "calculate_average_age", "parameters": {{"activity_name": "activity_name"}}}}
</Action>
<Observation>
{{"tool_name": "calculate_average_age", "result": {{"activity_name": "activity_name", "average_age": 18}}}}
</Observation>
</example>
"""
